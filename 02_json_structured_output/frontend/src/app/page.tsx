    ...
    <div className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col px-4 pb-24 pt-8">
      ...
      <Card className="flex-1">
        ...
        <CardContent className="space-y-3">
          {
            answers.length ===0 ? <p className="text-sm text-zinc-600">
              No answers yet. Ask a question below</p>: (
      ...
      <form ref={formRef} onSubmit={handleQuerySubmit} className="fixed inset-x-0 bottom-0 mx-auto w-full max-w-2xl px-4 py-4 backdrop-blur">
        <div className="flex gap-2">
          <Input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} placeholder="Type your question and press" disabled={loading} className="h-11"/>
