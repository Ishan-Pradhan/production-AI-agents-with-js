...
export async function askStructured(query: string): Promise<AskResult> {
    ...
    //Calls .withStructuredOutput(AskResultSchema) — a LangChain feature that forces the model to return JSON matching your Zod schema, and validates it automatically
